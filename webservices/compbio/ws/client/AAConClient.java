...
public class AAConClient {
	...
	AAConClient(String[] cmd) throws IOException {
		...
		SequenceAnnotation<AAConWS> msaws = connect();
		...
		if (inputFile != null) {
			...
			if (outFile != null) {
				outStream = IOHelper.getWriter(outFile);
			} else {
	 ...
	 * 
	 * 
	 * @return {@link AlignmentAnnotation}
	...
	public static SequenceAnnotation<AAConWS> connect()
		...
		@SuppressWarnings("unchecked")
		SequenceAnnotation<AAConWS> serviceIF = serv.getPort(portName,
